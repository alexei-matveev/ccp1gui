...
class DALTONCalc(qm.QMCalc):
    ...
    def WriteInput(self, filename=None, nowrite=None, only_dal=None, only_mol=None ):
        ...
        # Bit of a hack so that we can use the caled WriteInput method which is the only time
        # we should be called with a filename parameter
        if filename:
            nowrite=1
