...
class DALTONCalc(QMCalc):
    ...
    def __init__(self, **kw):
        ...
        self.set_parameter('dalton_script','dalton')
...
#        self.submission_tool.widget.pack(in_=page.jobgroup.interior())
    ...
    def __initialisetools(self):
        ...
        if not script:
            self.calc.set_parameter( 'dalton_script','PLEASE SET ME!' )
            self.Info("The location of your dalton script could not be determined\n" +
                      "Please set the location of the script in the job tab or\n" +
                      "set the dalton_script variable in your ccp1guirc file.")
        else:
