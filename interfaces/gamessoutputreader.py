...
#     #end def
    ...
    def _read_normal_modes_force(self,line):
        ...
        nuclearCoordinates = mol.get_coord_list()
        # is there a function to return the number of atoms in a molecule??
        n = len(nuclearCoordinates)
        maxroot = n*3
        line = self.fd.readline()
...
##                v.atoms.append(p)
    ...
    def _read_frequencies_force(self,line):
        ...
        self.transitionStrengths = []
        self.transitionIntensities = []
        n = len(self.molecules[-1].get_coord_list())
        ncoords = n*3
