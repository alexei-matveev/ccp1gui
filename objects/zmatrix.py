...
# get bond lengths
CH=get_bond_length('c','h')
CC=get_bond_length('c','c')
CO=get_bond_length('c','o')

f = Zfragment(title="methyl group")
f.add('C',-1,-2,-3,CC,109.4,120.0)
f.add('H', 1,-1,-2,CH,109.4, 60.0)
f.add('H', 1,-1, 2,CH,109.4,120.0)
f.add('H', 1,-1, 2,CH,109.4,240.0)
fragment_lib['Me'] = f

f = Zfragment(title="ethyl group")
f.add('C',-1,-2,-3,CC,109.4,120.0)
f.add('C', 1,-1,-2,CC,109.4, 60.0)
f.add('H', 1,-1, 2,CH,109.4,120.0)
f.add('H', 1,-1, 2,CH,109.4,240.0)
f.add('H', 2, 1, 3,CH,109.4, 60.0)
f.add('H', 2, 1, 3,CH,109.4,180.0)
...
f.add('C',-1,-2,-3,CC,109.4,120.0)
f.add('C', 1,-1,-2,CC,109.4, 60.0)
f.add('C', 2, 1,-1,CC,109.4,180.0)
f.add('H', 1,-1, 2,CH,109.4,120.0)
f.add('H', 1,-1, 2,CH,109.4,240.0)
f.add('H', 2, 1, 3,CH,109.4,120.0)
f.add('H', 2, 1, 3,CH,109.4,240.0)
f.add('H', 3, 2, 1,CH,109.4, 60.0)
f.add('H', 3, 2, 1,CH,109.4,180.0)
f.add('H', 3, 2, 1,CH,109.4,300.0)
fragment_lib['Pr'] = f
...
f.add('C',-1,-2,-3,CC,109.4,120.0)
f.add('C', 1,-1,-2,CC,109.4, 60.0)
f.add('C', 1,-1, 2,CC,109.4,120.0)
f.add('H', 1,-1, 2,CH,109.4,240.0)
f.add('H', 2, 1, 3,CH,109.4, 60.0)
f.add('H', 2, 1, 3,CH,109.4,180.0)
f.add('H', 2, 1, 3,CH,109.4,300.0)
f.add('H', 3, 1, 2,CH,109.4, 60.0)
f.add('H', 3, 1, 2,CH,109.4,180.0)
f.add('H', 3, 1, 2,CH,109.4,300.0)
fragment_lib['i-Pr'] = f
...
f.add('H', 3, 2, 1,CH,109.4, 60.0)
f.add('H', 3, 2, 1,CH,109.4,300.0)
f.add('H', 4, 3, 2,CH,109.4, 60.0)
f.add('H', 4, 3, 2,CH,109.4,300.0)
f.add('H', 4, 3, 2,CH,109.4,180.0)
fragment_lib['Bu'] = f
...
f.add('H', 3, 1, 2,CH,109.4,180.0)
f.add('H', 3, 1, 2,CH,109.4,300.0)
f.add('H', 4, 2, 1,CH,109.4, 60.0)
f.add('H', 4, 2, 1,CH,109.4,180.0)
f.add('H', 4, 2, 1,CH,109.4,300.0)
fragment_lib['i-Bu'] = f
...
f.add('H', 3, 1, 2,CH,109.4,180.0)
f.add('H', 3, 1, 2,CH,109.4,300.0)
f.add('H', 4, 1, 2,CH,109.4, 60.0)
f.add('H', 4, 1, 2,CH,109.4,180.0)
f.add('H', 4, 1, 2,CH,109.4,300.0)
fragment_lib['t-Bu'] = f

f = Zfragment(title="carbonyl group")
f.add('C',-1,-2,-3,CC,109.4,120.0)
f.add('x', 1,-1,-2,1.0, 90.0,  0.0)
f.add('o', 1, 2,-1,CO, 90.0,180.0)
fragment_lib['CO'] = f

f = Zfragment(title="phenyl group")
f.add('C',-1,-2,-3,CC,120.0,120.0)
f.add('C', 1,-1,-2,CC,120.0,  0.0)
f.add('C', 1,-1,-2,CC,120.0,180.0)
f.add('C', 2, 1,-1,CC,120.0,180.0)
f.add('C', 3, 1,-1,CC,120.0,180.0)
f.add('C', 4, 2, 1,CC,120.0,  0.0)
f.add('H', 2, 1, 3,CH,120.0,180.0)
f.add('H', 3, 1, 2,CH,120.0,180.0)
f.add('H', 4, 2, 1,CH,120.0,180.0)
f.add('H', 5, 3, 1,CH,120.0,180.0)
f.add('H', 6, 4, 2,CH,120.0,180.0)
fragment_lib['Ph'] = f
...
f.add('H', 2, 7, 1,CH, 90.0,180.0)
f.add('H', 3, 8, 1,CH, 90.0,180.0)
f.add('H', 4, 9, 1,CH, 90.0,180.0)
f.add('H', 5,10, 1,CH, 90.0,180.0)
f.add('H', 6,11, 1,CH, 90.0,180.0)
...
f.add('H', 2, 8, 1,CH, 90.0,180.0)
f.add('H', 3, 9, 1,CH, 90.0,180.0)
f.add('H', 4,10, 1,CH, 90.0,180.0)
f.add('H', 5,11, 1,CH, 90.0,180.0)
f.add('H', 6,12, 1,CH, 90.0,180.0)
f.add('H', 7,13, 1,CH, 90.0,180.0)
...
f.add('x', 2, 1,-1,1.0, 90.0,180.0)
f.add('x', 3, 1,-1,1.0, 90.0,180.0)
f.add('H', 2, 3,-1,CH,120.0, 90.0)
f.add('H', 2, 3,-1,CH,120.0,270.0)
f.add('H', 3, 2,-1,CH,120.0, 90.0)
f.add('H', 3, 2,-1,CH,120.0,270.0)
